...
-   Tumor differentiation was significantly associated with survival,
    with poorer differentiation linked to higher hazard of death

-   Estrogen receptor status also emerged as a significant predictor,
    highlighting the importance of tumor biology
...
Demonstrates how survival analysis can reveal nuanced relationships in real‑world clinical datasets
...
Results highlight the multifactorial nature of breast cancer prognosis
...
The Cox model remains a powerful tool for analyzing survival in complex clinical datasets
